...
const timeline = [
  ...
  { year: "2024", note: "Built ProShop & Plate from the ground up" },
          ...
          <div className="flex flex-col gap-6">
            ...
            <FadeIn delay={0.1}>
              <p className="text-base leading-[1.85]" style={{ color: "var(--text-2)" }}>
                ...
                streaming pipelines, screen recording with annotation, and social feeds — I
                bring a performance-first, detail-obsessed mindset to every project.
              </p>
            </FadeIn>
